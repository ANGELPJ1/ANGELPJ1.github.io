    ...
    <div class="container">
        ...
        <div class="main-content">
            <div class="form-container">
                <h2>Registrar opiniones de clientes</h2>
                <form action="registrar_testimonio.php" method="POST" enctype="multipart/form-data">
                    <label>Nombre:</label>
                    ...
                    <label>Opinión:</label>
                    <textarea name="opinion" rows="4" required></textarea>

                    <label>Foto:</label>
                    <input type="file" name="imagen" accept="image/*" required>

                    <input type="submit" name="submit" value="Guardar Testimonio">
                </form>
            </div>
        </div>
    </div>
